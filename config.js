...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? '•Madeby•Ave' : process.env.OWNER_NAME,
  ...
  antibadword :  process.env.ANTI_BAD_WORD === undefined ? 'null' : process.env.ANTI_BAD_WORD,
